...
use ORFS\Bundle\StoreBundle\Entity\Images;
use ORFS\Bundle\StoreBundle\Form\ImagesType;
...
class ImagesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ORFSStoreBundle:Images')->findAll();
     ...
     * @Method("POST")
     * @Template("ORFSStoreBundle:Images:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ORFSStoreBundle:Images')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ORFSStoreBundle:Images:edit.html.twig")
     */
