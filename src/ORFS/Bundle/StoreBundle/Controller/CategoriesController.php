...
use ORFS\Bundle\StoreBundle\Entity\Categories;
use ORFS\Bundle\StoreBundle\Form\CategoriesType;
...
class CategoriesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ORFSStoreBundle:Categories')->findAll();
     ...
     * @Method("POST")
     * @Template("ORFSStoreBundle:Categories:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ORFSStoreBundle:Categories')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ORFSStoreBundle:Categories:edit.html.twig")
     */
