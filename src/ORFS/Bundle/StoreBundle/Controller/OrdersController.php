...
use ORFS\Bundle\StoreBundle\Entity\Orders;
use ORFS\Bundle\StoreBundle\Form\OrdersType;
...
class OrdersController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ORFSStoreBundle:Orders')->findAll();
     ...
     * @Method("POST")
     * @Template("ORFSStoreBundle:Orders:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ORFSStoreBundle:Orders')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ORFSStoreBundle:Orders:edit.html.twig")
     */
