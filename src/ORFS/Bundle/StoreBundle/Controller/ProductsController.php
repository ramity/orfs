...
use ORFS\Bundle\StoreBundle\Entity\Products;
use ORFS\Bundle\StoreBundle\Form\ProductsType;
...
class ProductsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ORFSStoreBundle:Products')->findAll();
     ...
     * @Method("POST")
     * @Template("ORFSStoreBundle:Products:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ORFSStoreBundle:Products')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ORFSStoreBundle:Products:edit.html.twig")
     */
